...
class STGCN_SA(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.stgcn = STGCN(n_agents, state_dim + unary_input_dim + type_dim + tim_dim, n_features, kernel_size,
    ...
    def forward(self, data=None, hp=None):
        ...
        if self.config['input_feature'] == 'physical':
            ...
            inputs = torch.cat([states, nlm_inputs[1], types.unsqueeze(1).repeat(1, length, 1, 1)], dim=3)
